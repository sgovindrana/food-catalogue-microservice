  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t govindrana/foodcatalogue:${VERSION} .'
          sh 'docker push govindrana/foodcatalogue:${VERSION}'
      }
    }
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: govindrana\\/restaurantlisting:${VERSION}/" aws/foodcatalogue-manifest.yml
        '''
